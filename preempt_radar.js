...
(function () {
    ...
    var ECON_HINTS = ['경제', '금리', '환율', '물가', '주식', '증시', '코스피', '코스닥', '부동산', '아파트', '집값', '전세',
        ...
        // ★지정학·국가위기(2026-07-17 감사) — 채널을 키운 결(이란전쟁·중국위기·K방산)이 '경제 아님'으로
        //   걸러지던 구멍. 파도 레이더 실측 히트군(잠수함·홍수·댐·수주전)과 정렬.
        '전쟁', '미사일', '공습', '폭격', '제재', '봉쇄', '핵', '방산', '잠수함', '전차', 'K9', 'K2',
        '수주', '조선소', '중국', '미국', '러시아', '우크라', '이란', '이스라엘', '대만', '북한',
        '트럼프', '푸틴', '시진핑', '홍수', '댐', '지진', '붕괴', '폭발', '정전', '전력난', '희토류', '반도체법'];
